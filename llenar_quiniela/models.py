...
class imagenes_cartas(models.Model):
    ...
    E = models.TextField(max_length = 1000000, default = 'NC')
    PI = models.TextField(max_length = 1000000, default = 'NC')
    CM = models.TextField(max_length = 1000000, default = 'NC')
