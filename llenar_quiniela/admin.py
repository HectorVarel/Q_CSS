...
from .models import EquiposPartidos, Prediccion, Fotos_quiniela, imagenes_cartas, Equipos_fotos, Equipos_gol, Juegos_pendientes, Equipos_tiempo, Estadisticas, Momios
